    ...
    <div>
      <div className="relative">
        <section className="">
          ...
          <p className='absolute top-1/4 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white text-2xl bg-purple-300/50  border-solid border-2 border-purple-300 rounded-lg'>
